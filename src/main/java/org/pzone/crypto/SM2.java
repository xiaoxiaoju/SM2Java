...
public class SM2 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		SM2 sm02 = new SM2();
		 BigInteger px = new BigInteger("3E2A11321A7EDAFDDECB44ACB5A15D853F9178DEF93220AF096788C63EAE1CE6".replace(" ", ""), 16);
		 BigInteger py = new BigInteger("B2C4BF29A2C3BC1C78E76286A68FF07ACF6946615424AEF47EBCEA5A503FB75C".replace(" ", ""), 16);
		 ECPoint publicKey = sm02.curve.createPoint(px, py);
		 BigInteger privateKey = new BigInteger("B55CE6F0BFD3D6E24DA599F07BDBDD1368511C67DC70165C35854722B56B8DD6".replace(" ", ""), 16);
